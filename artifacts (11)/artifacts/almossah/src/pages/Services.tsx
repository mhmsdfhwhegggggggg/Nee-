    ...
    <div className="flex flex-col min-h-screen bg-[#F8F5F0]" dir="rtl">
      ...
      <section className="relative h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          background: "linear-gradient(135deg, rgba(139,0,0,0.88) 0%, rgba(45,90,39,0.82) 100%)"
        }} />
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              {/* Accent */}
              <div className="absolute -bottom-6 -right-6 bg-[#8B0000] text-white rounded-2xl px-6 py-4 shadow-xl shadow-red-900/30">
              ...
              <div className="absolute -top-5 -left-5 w-16 h-16 bg-yellow-300 rounded-2xl flex items-center justify-center shadow-lg">
                <GraduationCap size={30} className="text-[#8B0000]" />
              </div>
            </motion.div>
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-black text-[#8B0000] mb-6 leading-tight">
                التعليمية
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {[
                  ...
                  <div key={title} className="bg-[#F8F5F0] rounded-2xl p-5 hover:shadow-md hover:bg-white transition-all group">
                    <div className="w-9 h-9 bg-[#8B0000]/10 rounded-xl flex items-center justify-center text-[#8B0000] mb-3 group-hover:bg-[#8B0000] group-hover:text-white transition-colors">
                      {icon}
                    </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <span className="inline-block text-[#2D5A27] font-bold text-xs tracking-[0.25em] uppercase mb-4 border border-[#2D5A27]/30 rounded-full px-4 py-1">
                الخدمة الثانية
              </span>
              <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-2 leading-tight">
                التأمين
              </h2>
              <h2 className="text-4xl md:text-5xl font-black text-[#2D5A27] mb-6 leading-tight">
                الصحي
              </h2>
              <p className="text-gray-600 text-lg leading-[1.9] mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {[
                  ...
                  <div key={title} className="bg-white rounded-2xl p-5 hover:shadow-md transition-all group">
                    <div className="w-9 h-9 bg-[#2D5A27]/10 rounded-xl flex items-center justify-center text-[#2D5A27] mb-3 group-hover:bg-[#2D5A27] group-hover:text-white transition-colors">
                      {icon}
                    </div>
                    <div className="font-bold text-gray-900 text-sm mb-1">{title}</div>
                    <div className="text-gray-500 text-xs leading-relaxed">{desc}</div>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/programs#insurance">
                  <button className="bg-[#2D5A27] hover:bg-[#234a1f] text-white font-bold px-8 h-12 rounded-full transition-all hover:shadow-lg hover:shadow-green-900/20">
                    استفسر عن التأمين
                  </button>
                </Link>
                <Link href="/register">
                  <button className="border-2 border-[#2D5A27] text-[#2D5A27] hover:bg-[#2D5A27] hover:text-white font-bold px-8 h-12 rounded-full transition-all">
                    اشترك الآن
                  </button>
                </Link>
              </div>
            ...
            >
              ...
              {/* Accent */}
              <div className="absolute -bottom-6 -left-6 bg-[#2D5A27] text-white rounded-2xl px-6 py-4 shadow-xl shadow-green-900/30">
              ...
              <div className="absolute -top-5 -right-5 w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center shadow-lg">
                <HeartPulse size={30} className="text-[#2D5A27]" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <div className="w-14 h-1 bg-[#8B0000] mx-auto rounded-full" />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="text-[72px] font-black text-gray-100 leading-none absolute top-4 left-5 group-hover:text-[#8B0000]/10 transition-colors select-none">
                  {f.num}
                </div>
                <div className="relative z-10">
                  <CheckCircle2 size={22} className="text-[#8B0000] mb-4" />
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#8B0000] to-[#2D5A27]" />
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <Link href="/register">
            <button className="bg-white text-[#8B0000] hover:bg-yellow-300 hover:text-gray-900 font-black text-lg px-12 h-14 rounded-full shadow-2xl transition-all hover:scale-[1.02]">
              سجّل الآن مجاناً
            </button>
          </Link>
        </div>
