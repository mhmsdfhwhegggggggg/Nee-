        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-[110px]">
            ...
            <div className="hidden lg:flex items-center gap-2">
              <Link href="/nassir">
                <button className={`flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-full border-2 transition-all ${
                  isActive("/nassir")
                    ? "border-[#C41E24] text-[#C41E24] bg-[#C41E24]/5"
                    : "border-[#C41E24]/40 text-[#C41E24] hover:border-[#C41E24] hover:bg-[#C41E24]/5"
                }`}>
                  <Bot size={15} />
                  ناصر مساعدك الذكي
                </button>
              ...
              <Link href="/admin/dashboard">
                <div className="text-xs text-gray-400 hover:text-[#C41E24] cursor-pointer transition-colors px-2">
                  لوحة التحكم
                </div>
              </Link>
              <Link href="/register">
                <button className="bg-[#C41E24] hover:bg-[#A81920] text-white font-bold text-sm px-5 py-2.5 rounded-full transition-all hover:shadow-lg hover:shadow-red-900/20 active:scale-95">
                  سجّل الآن
                </button>
              </Link>
            </div>
          ...
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-100 shadow-2xl max-h-[80vh] overflow-y-auto">
            <div className="container mx-auto px-6 py-4 flex flex-col gap-1">
              ...
              <div className="mt-3 pt-3 border-t border-gray-100 flex flex-col gap-3">
                <Link href="/nassir">
                  <button
                    className="w-full flex items-center justify-center gap-2 border-2 border-[#C41E24] text-[#C41E24] font-bold py-3 rounded-xl"
