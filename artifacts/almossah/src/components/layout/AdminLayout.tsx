import { Link, useLocation } from "wouter";
  ...
  import { LayoutDashboard, Users, FileText, Handshake, BarChart, LogOut, Settings, Menu, Image as ImageIcon, Phone, KeyRound, ClipboardList, ClipboardEdit, Bot } from "lucide-react";
  ...
  export function AdminLayout({ children }: AdminLayoutProps) {
    ...
    const navItems = [
      ...
      { href: "/admin/training-form", label: "نموذج الدورات والتأمين", icon: <ClipboardList size={20} /> },
