      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6 bg-white/5 p-2 rounded-lg inline-flex">
              <img src="/logo.png" alt="المؤسسة الوطنية للتنمية الشاملة" className="h-10 w-auto object-contain bg-white rounded p-1" onError={(e) => { e.currentTarget.style.display = 'none' }} />
              <span className="font-bold text-lg text-white">المؤسسة الوطنية للتنمية الشاملة</span>
            </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">
            جميع الحقوق محفوظة &copy; {new Date().getFullYear()} المؤسسة الوطنية للتنمية الشاملة
          </p>
