                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {formData.imageUrl && (
                      <div className="relative">
                        <img src={formData.imageUrl} alt="" className="h-14 w-14 object-cover rounded-full border border-slate-200" />
                        <button type="button" onClick={() => setFormData(prev => ({ ...prev, imageUrl: "" }))} className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-xs leading-none">×</button>
                      </div>
                    )}
                  </div>
                </div>
